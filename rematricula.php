...
<body>
    <div class="w3-container w3-teal">
        <h3 class="w3-center">Rematricula</h3>
        ...
        <a href="lucassantos_AG5_TI2.php" onclick="alert('Encaminhada com Sucesso')">
                <img src="https://img.icons8.com/fluent/48/000000/checked-checkbox.png"/>
        </a>
    </div>
</body>
</html>